...
* to store more data in it. returns -1 if failed, and 0 if succeded.
*/
...
/*
* The function gets a table, object to add and index, and add the data to the
* desired list according to the given index. If succeeded it returns the array index of the
* the added data, and if not it returns -1;
*/
int addToList(Table* table, Object* obj, int index);
